defmodule MyAppWeb.CredentialAuth do
  ...
  the current_credential:
      ...
      defmodule MyAppWeb.PageLive do
        ...
        on_mount {MyAppWeb.CredentialAuth, :mount_current_credential}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{MyAppWeb.CredentialAuth, :ensure_authenticated}] do
