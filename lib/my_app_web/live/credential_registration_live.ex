defmodule MyAppWeb.CredentialRegistrationLive do
  use MyAppWeb, :live_view

  alias MyApp.Credentials
  alias MyApp.Credentials.Credential
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/credentials/log_in"} class="font-semibold text-brand hover:underline">
            Log in
          </.link>
          to your account now.
        </:subtitle>
      ...
      <.simple_form
        ...
        action={~p"/credentials/log_in?_action=registered"}
        method="post"
      >
